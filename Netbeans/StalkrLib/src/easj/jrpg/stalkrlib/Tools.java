...
public class Tools
{
	...
	private static final String UVS02 = "^([A-Fa-f0-9]{8}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{12}){1}\\|([A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+(?:\\.[A-Za-z]{2,4}){1,2}){0,1}\\|([A-Za-z0-9]+){0,1}\\|([A-Za-z0-9\\ ]+){0,1}\\|([A-Za-z0-9\\ ]+){0,1}\\|([A-Za-z0-9\\ ]+){0,1}\\|([0-9]+){0,1}\\|((?:-){0,1}[0-9]+\\.[0-9]+){0,1}\\|((?:-){0,1}[0-9]+\\.[0-9]+){0,1}\\|([0-9]+){0,1}\\|([0-9]+){0,1}\\|([A-Za-z0-9\\ ]+){0,1}\\|([0-9]+){0,1}\\|([0-9]+){0,1}\\|([0-1]{5}){0,1}\\|([0-1]{4}){0,1}\\|([0-1]{5}){0,1}\\|([0-1]{3}){0,1}\\|([0-1]{2}){0,1}(?:\\{([A-Fa-f0-9]{8}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{12}){1}\\|([0-9]+){0,1}\\|([A-Za-z0-9\\ ]+){0,1}\\|([0-9]+){0,1}\\|([0-9]+){0,1}\\|([0-1]{5}){0,1}\\|([0-1]{4}){0,1}\\|([0-1]{5}){0,1}\\|([0-1]{3}){0,1}\\|([0-1]{2}){0,1}|)*$";
