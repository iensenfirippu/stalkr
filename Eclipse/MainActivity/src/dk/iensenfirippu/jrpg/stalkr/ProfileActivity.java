...
//			((Spinner)	this.findViewById(R.id.profile_spn_gender))		.setSelection(_user.getDescription().getGender().);
...
//			((Spinner)	this.findViewById(R.id.profile_spn_drinking))	.setSelection(_user.getDescription().getDrinking().getList().get(0).ordinal());
	...
	{
		String [] smokingOptions = new String[] { "Yes", "No", "Occasionally" };
		Intent _intent = new Intent(this, MultiSelect.class);
		_intent.putExtra("Options", smokingOptions);
