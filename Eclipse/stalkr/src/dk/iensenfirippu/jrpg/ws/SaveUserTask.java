...
public class SaveUserTask extends AbstractProgressableAsyncTask<SoapObject, SimpleReturnStringBO>
{
    public static final String TAG = "SaveUserTask";
    ...
    private static final String WS_METHOD_NAME = "saveUser";
    ...
    public static SoapObject createRequest(String username, String password, String userasstring)
    {
        ...
        property3.setName("user");
        property3.setValue(userasstring);
