...
public class GetUserTask extends AbstractProgressableAsyncTask<SoapObject, SimpleReturnStringBO>
{
    public static final String TAG = "GetUserTask";
    ...
    private static final String WS_METHOD_NAME = "getUser";
    ...
    public static SoapObject createRequest(String username, String password, String uuid)
    {
